...
public class AfterLoginController implements Initializable {
    ...
    @FXML
    private void myOrderClicked(ActionEvent event) throws IOException {
    ...
    private void cartClicked(MouseEvent event) throws IOException {
        ...
        Stage stage=new Stage();
        Parent root = FXMLLoader.load(getClass().getResource("pageCart.fxml"));
        Scene scene = new Scene(root);
    ...
    @FXML
    private void gameClicked(MouseEvent event) {
    }
